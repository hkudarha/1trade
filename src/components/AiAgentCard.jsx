...
const AiAgentCard = ({ agent }) => {
  ...
  return (
      <div
          ...
          key={agent.id}
          className={`rounded-3xl p-6 text-white bg-gradient-to-br ${agent.bgColor} relative shadow-xl flex items-center justify-between`}
      >
          <div className='w-1/2'>
              <div>
          ...
          <div className="w-1/2 px-10 space-y-1 text-xl">
              ...
              <p><span className="font-semibold">Ai Agent fee:</span> {agent.fee}</p>
          </div>

...
export const CardSection = ({ filter }) => {
  ...
  const dataMap = {
    ALL: [
      { title: " Registered Member", value: 250 },
    ...
    TODAY: [
      { title: " Registered Member", value: 20 },
    ...
    YESTERDAY: [
      { title: " Registered Member", value: 30 },
      { title: "Total Member A", value: 8 },
      { title: "Total Member B", value: 12 },
      { title: "Total Member C", value: 10 },
    ...
    WEEK: [
      { title: " Registered Member", value: 100 },
    ...
    MONTH: [
      { title: " Registered Member", value: 200 },
